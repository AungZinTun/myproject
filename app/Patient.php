...
class Patient extends Model
{
    ...
    protected $fillable = 
       // page1
    ['mpi_code', 'no_art_reason', 'date_enrolled', 'township_id', 'pmct_code', 'name', 'dob', 'address', 'gravida', 'parity', 'edd', 'hiv_status', 
       // page 2
    ...
    'baby_outcome', 'baby_outcome_dead_date', 'pep', 'pep_option', 'pep_not_reason', 'cpt', 'cpt_not_reason', 
        'dna_pcr', 'dna_pcr_date', 'dna_pcr_result','dna_pcr_not_reason', 'baby_arv', 'baby_arv_no_reason', 'baby_txt_start_date', 'txt_unit', 'txt_regimen', 'baby_art_code', 'feeding_option', 'bf_stop_date', 
