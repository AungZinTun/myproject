...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('township_id', trans('quickadmin.users.fields.township').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('health_facility', trans('quickadmin.users.fields.health-facility').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('health_facility', old('health_facility'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
